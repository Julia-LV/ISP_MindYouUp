...
$team = [
  ["name" => "Julia Vidal", "img" => "images/julia.jpg"],
  ["name" => "Luis Duarte", "img" => "images/luis.jpg"],
  ["name" => "Andrey Maslennikov", "img" => "images/andrey.jpg"],
  ["name" => "Bhawna Panwar", "img" => "images/bhawna.jpg"],
  ["name" => "Rodrigo Neves", "img" => "images/rodrigo.jpg"],
];
?>
<!doctype html>
<html lang="en">
...
<body class="bg-[#fff7ea] text-[#384341] font-sans">
  ...
  <main class="py-14">
    <div class="max-w-[1120px] mx-auto px-4">
      <section class="rounded-[26px] border border-[#f0d9d2]/85 shadow-[0_18px_50px_rgba(0,0,0,0.10)]
                      p-8 backdrop-blur-[6px]
                      bg-[linear-gradient(180deg,rgba(255,253,248,0.92),rgba(255,253,248,0.86))]"
               aria-labelledby="aboutTitle">

        <div class="grid gap-2.5 mb-5">
          <h1 class="m-0 text-[2.1rem] leading-tight font-extrabold text-[#0a4936] tracking-[-0.02em]" id="aboutTitle">
            About us
          </h1>
          <p class="m-0 text-[#5b6664] text-[1rem] leading-relaxed max-w-[78ch]">
            We are Nexus Tech, a student-led software team founded in 2025, building web-based solutions
            that are practical, easy to use, and tailored to real-world needs.
          </p>
        </div>

        <div class="grid gap-[18px] mt-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          <?php foreach ($team as $m): ?>
            <article class="relative overflow-hidden rounded-[22px]
                            border border-[#f0d9d2]/85 bg-white/90
                            shadow-[0_10px_26px_rgba(0,0,0,0.08)]
                            transition hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(0,0,0,0.12)]
                            hover:border-[#0f684f]/20">
              <div class="absolute left-0 top-0 right-0 h-1 bg-[linear-gradient(90deg,#0a4936,#0f684f)] opacity-90"></div>

              <div class="px-[18px] pt-[22px] pb-5 grid justify-items-center gap-3 text-center">
                <div class="w-[136px] h-[136px] rounded-full overflow-hidden bg-black
                            shadow-[0_14px_26px_rgba(0,0,0,0.14)]
                            border-[3px] border-white/90">
                  <img
                    src="<?php echo htmlspecialchars($m['img']); ?>"
                    alt="<?php echo htmlspecialchars($m['name']); ?> photo"
                    loading="lazy"
                    class="w-full h-full object-cover block scale-[1.02] transition-transform duration-200 hover:scale-110"
                  />
                </div>

                <p class="m-0 text-[1.05rem] font-extrabold text-[#0a4936] tracking-[-0.01em]">
  ...
  <!-- Footer -->
  <footer class="bg-[#0d5b43] text-white border-t-2 border-[#0a4936]">
