<nav id="sidebar"
     class="fixed top-0 left-0 h-full bg-[#FCFBF7] shadow-inner
            ...
            -translate-x-full md:translate-x-0  <!-- Desktop sempre visível -->
            w-20"> <!-- Largura inicial com apenas ícones -->
...
<!-- NAVIGATION LINKS -->
    <div class="w-full overflow-y-auto">
        <ul class="space-y-3 py-4">
            <!-- HOME -->
            <li>
                <a href="../../pages/patient/home_patient.php" 
                   class="sidebar-link flex items-center gap-4 py-2 px-4 rounded-lg transition
                          hover:bg-[#005949] active:bg-[#005949]
                          group">
                    <svg class="w-6 h-6 text-gray-700 group-hover:text-white group-active:text-white" 
                    ...
                    <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Home</span>
                </a>
            </li>
            ...
            <a href="ticlog_motor.php"
               class="sidebar-link flex items-center gap-4 py-2 px-4 rounded-lg transition
                ...
                <svg class="w-6 h-6 text-gray-700 group-hover:text-white group-active:text-white" 
                    ...
                    <path class="group-hover:fill-white group-active:fill-white"
                          fill="#005949"
                          d="M256 512a256 256 0 1 0 0-512 256 256 0 1 0 0 512zM232 344l0-64-64 0c-13.3 0-24-10.7-24-24
                ...
                <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Tic Log</span>
            </a>
        </li>
        ...
        <li>
            <a href="new_emotional_diary.php"
               class="sidebar-link flex items-center gap-4 py-2 px-4 rounded-lg transition
                ...
                <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Emotional Diary</span>
            </a>
        </li>
        ...
        <li>
            <a href="../../pages/patient/medication_tracking.php"
               class="sidebar-link flex items-center gap-4 py-2 px-4 rounded-lg transition
                ...
                <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Track Medicines</span>
            </a>
        </li>
        ...
        <li>
            <a href="chat.php"
               ...
               <svg class="w-6 h-6 text-gray-700 group-hover:text-white group-active:text-white" 
                ...
                <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Chat</span>
            </a>
        </li>
        ...
        <li>
            <a href="../../pages/patient/resourcehub_patient.php"
               class="sidebar-link flex items-center gap-4 py-2 px-4 rounded-lg transition
                ...
                <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Resource Hub</span>
            </a>
        </li>
        <!-- FORMS PAGE -->
        <li>
            <a href="../../pages/patient/YGTSS_form.php"
               class="sidebar-link flex items-center gap-4 py-2 px-4 rounded-lg transition
                ...
                <span class="link-text text-green-800 font-medium hidden group-hover:text-white group-active:text-white">Forms</span>
            </a>
        </li>
    </ul>
    </div>
    ...
    <div class="w-full mt-auto">
        <div class="w-full mt-32 border-t border-gray-300"> 
        <ul class="space-y-2 py-4"> 
            ...
            <li>
                <a href="../auth/logout.php"
                    ...
                    <span class="link-text text-black-800 font-bold hidden group-hover:text-white group-active:text-white">Logout</span>
                </a>
            </li>
        </ul>
        </div>
