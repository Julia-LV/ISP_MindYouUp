                ...
                <ul class="flex items-center space-x-6">
                    ...
                    <li>
                        <a href="../../pages/patient/patient_profile.php" 
                            class="sidebar-link flex p-2 block rounded-full transition-transform duration-200 
                                hover:scale-110 hover:bg-[#005949] active:bg-[#005949]
                                group">
                    ...
                    <li>
                        <a href="../../pages/common/settings.php" 
                            class="sidebar-link flex p-2 block rounded-full transition-transform duration-200 hover:scale-110
