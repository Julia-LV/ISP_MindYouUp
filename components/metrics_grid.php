...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <label for="anxiety" class="block text-sm font-medium text-gray-700 mb-2">Anxiety Level</label>
    ...
    <!-- Box 3: Stress Slider -->
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <label for="stress" class="block text-sm font-medium text-gray-700 mb-2">Stress Level</label>
        <!-- We use our custom CSS class "diary-slider" -->
