        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Manage your patient list and statuses.</p>
                </div>
                
                <a href="search_patients.php" class="flex items-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-xl shadow-md hover:bg-indigo-700 transition">
                    ...
                    <?php while($patient = $result->fetch_assoc()): ?>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col items-center text-center relative hover:shadow-md transition">
                            ...
                            <div class="w-full flex justify-between items-start absolute top-4 px-4">
                                ...
                                <form action="../common/delete_handler.php" method="POST" onsubmit="return confirm('Remove this patient from your list?');">
                                    <input type="hidden" name="link_id" value="<?= $patient['Link_ID'] ?>">
                                    <button type="submit" class="text-gray-300 hover:text-red-500 transition p-1" title="Remove">
