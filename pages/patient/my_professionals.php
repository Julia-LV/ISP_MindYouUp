    ...
    <main class="flex-1 overflow-y-auto p-8">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <a href="search_professionals.php" class="flex items-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-xl shadow-md hover:bg-indigo-700 transition">
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($doc = $result->fetch_assoc()): ?>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col items-center text-center relative hover:shadow-md transition">
                            ...
                            <form action="../common/delete_handler.php" method="POST" onsubmit="return confirm('Remove this professional from your contacts?');" 
                                  class="absolute top-4 right-4">
                                <input type="hidden" name="link_id" value="<?= $doc['Link_ID'] ?>">
                                <button type="submit" class="text-gray-300 hover:text-red-500 transition p-2" title="Remove">
